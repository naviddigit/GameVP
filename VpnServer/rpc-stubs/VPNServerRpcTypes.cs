...
namespace SoftEther.VPNServerRpc
{
    ...
    public class VpnRpcEnumSessionItem
    {
        ...
        /// <summary>
        /// Remote server name By Navid Add
        /// </summary>
        ...
        /// Remote session
        /// </summary>
        public bool RemoteSession_bool { get; set; }

        /// <summary>
        /// Remote server name
        /// </summary>
        public string RemoteHostname_str { get; set; }
        ...
        /// IP address
        /// </summary>
        public string ClientIP_ip { get; set; }

        /// <summary>
        /// Host name
        /// </summary>
        public string Hostname_str { get; set; }

        /// <summary>
        /// Maximum number of underlying TCP connections
        /// </summary>
        public uint MaxNumTcp_u32 { get; set; }

        /// <summary>
        /// Number of current underlying TCP connections
        /// </summary>
        public uint CurrentNumTcp_u32 { get; set; }

        /// <summary>
        /// Packet size transmitted
        /// </summary>
        public ulong PacketSize_u64 { get; set; }

        /// <summary>
        /// Number of packets transmitted
        /// </summary>
        public ulong PacketNum_u64 { get; set; }

        /// <summary>
        /// Is a Cascade VPN session
        /// </summary>
        public bool LinkMode_bool { get; set; }

        /// <summary>
        /// Is a SecureNAT VPN session
        /// </summary>
        public bool SecureNATMode_bool { get; set; }

        /// <summary>
        /// Is the VPN session for Local Bridge
        /// </summary>
        public bool BridgeMode_bool { get; set; }

        /// <summary>
        /// Is a Layer-3 Switch VPN session
        /// </summary>
        public bool Layer3Mode_bool { get; set; }

        /// <summary>
        /// Is in Bridge Mode
        /// </summary>
        public bool Client_BridgeMode_bool { get; set; }

        /// <summary>
        /// Is in Monitor Mode
        /// </summary>
        public bool Client_MonitorMode_bool { get; set; }

        /// <summary>
        /// VLAN ID
        /// </summary>
        public uint VLanId_u32 { get; set; }

        /// <summary>
        /// Unique ID of the VPN Session
        /// </summary>
        public byte[] UniqueId_bin{ get; set; }

        /// <summary>
        /// Creation date and time
        /// </summary>
        public DateTime CreatedTime_dt{ get; set; }

        /// <summary>
        /// Last communication date and time
        /// </summary>
        public DateTime LastCommTime_dt{ get; set; }
    }


    public class VpnRpcEnumSessionItemDublicate
    {
        ...
        /// <summary>
        /// Agent_srt By Navid Add
        /// </summary>
        public string Agent_srt { get; set; }
        public List<VpnRpcEnumSessionItemDublicateDetails> VpnRpcEnumSessionItemDublicateDetails { get; set; }
        //public string Hostname_str { get; set; }

    }
    public class VpnRpcEnumSessionItemDublicateDetails
    {
        public string Name_str { get; set; }
        public string RemoteHostname_str { get; set; }
        public string ClientIP_ip { get; set; }
